        ...
        <form action="<?= base_url(route_to('signin')) ?>" method="POST">
            <div class="field">
                <p class="control has-icons-left has-icons-right">
                    <input class="input" type="email" name="user_email" placeholder="Email" value="<?= old('user_email') ?>">
...
<!-- <section class="hero is-fullheight">
    <div class="hero-body has-text-centered">
        <div class="login">
            <svg id="logo-6" width="325" viewBox="0 0 134 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
